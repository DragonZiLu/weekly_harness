...
COMPANIES = {
    ...
    "乳业": {
        "伊利股份": {"ts_code": "600887.SH", "category": "消费成长红利", "certainty": "A-",
                   "moat": "乳业双寡头·全国渠道+品牌壁垒", "comment": "乳业龙头，连续20+年分红，股息率4.9%，ROE 21%+"},
    },
    "农业": {
        "北大荒": {"ts_code": "600598.SH", "category": "消费成长红利", "certainty": "B+",
                   "moat": "国家粮仓·黑土地资源垄断·央企农业龙头", "comment": "黑龙江农垦龙头，粮食安全战略资产，股息率3.9%，分红稳定"},
    },
    # ── 第四类：ETF红利 ────────────────────────────────
    "ETF": {
        ...
        "现金流ETF国泰": {"ts_code": "159399.SZ", "category": "ETF红利", "certainty": "A",
                   "moat": "跟踪富时中国A股自由现金流聚焦指数·高FCF质量筛选", "comment": "中国版现金牛ETF，侧重企业真实造血能力"},
        "自由现金流ETF华夏": {"ts_code": "159201.SZ", "category": "ETF红利", "certainty": "A",
                   "moat": "跟踪国证自由现金流指数·规模184亿", "comment": "华夏现金流ETF，规模最大，流动性好"},
        "中证800现金流ETF广发": {"ts_code": "159229.SZ", "category": "ETF红利", "certainty": "A-",
                   "moat": "跟踪中证800自由现金流指数·中大盘FCF筛选", "comment": "广发800现金流ETF，与自建E版成分池重合度高"},
    },
    # ── 第三类：周期资源红利 ─────────────────────────────────
    "矿业": {
...
SECTOR_THRESHOLDS = {
    ...
    "乳业": {
        ...
        "comment": "乳业双寡头4.5%+可布局，5.5%+积极加仓，ROE 20%+高质量消费成长",
    },
    "汽车": {
        "watch": 3.0, "buy": 4.0, "add": 5.0, "full": 6.0, "reduce": 2.5,
...
FALLBACK_DATA = {
    "600900.SH": {  # 长江电力
        # API实测(2026-06-22): close=26.94, pe=18.27, pb=2.89, dv_ttm=3.50%, mv=6592亿
        # 分红: 2025中期0.21(ex:20260212) + 2024年报0.733(ex:20250718)
        # TTM最近12M = 0.21(中期) + 0.733(24年报) = 0.943，对应3.50% ✓ 与dv_ttm吻合
        # 2025年报分红预案尚未公告，预估参考24年报0.733，保守估算全年约0.943
        "close": 26.94, "pe_ttm": 18.27, "pb": 2.89,
        "div_yield": 3.50, "roe": 15.79, "dps_latest": 0.943,
        "buyback_yield": 0.0, "revenue_growth": 8.1, "net_profit_growth": 19.3,
        "payout_ratio": 70.0, "total_mv": 6592.0,
        "note": "API实测(2026-06-22)：close=26.94，dv_ttm=3.50%(TTM=中期0.21+24年报0.733)，ROE 15.79%，净利+19.3%；2025年报分红预案待公告"
    },
    "600886.SH": {  # 国投电力
    ...
    "600938.SH": {  # 中国海油
        # API实测(2026-06-22): close=30.54, pe=11.64, pb=1.73, dv_ttm=4.16%, mv=14516亿
        # 分红: 2025中期0.666(ex:20251017) + 2024年报0.605(ex:20250711)
        # TTM = 0.666+0.605 = 1.271元，1.271/30.54=4.16% ✓ 与dv_ttm吻合
        # 2025年报分红预案待公告；75美元油价中枢下，全年预期DPS约1.3-1.5元
        "close": 30.54, "pe_ttm": 11.64, "pb": 1.73,
        "div_yield": 4.16, "roe": 19.51, "dps_latest": 1.271,
        "buyback_yield": 0.0, "revenue_growth": 0.9, "net_profit_growth": 11.4,
        "payout_ratio": 45.0, "total_mv": 14516.0,
        "note": "API实测(2026-06-22)：close=30.54，dv_ttm=4.16%(TTM=中期0.666+24年报0.605)，ROE 19.51%，净利+11.4%；75美元油价下周期底部高安全边际"
    },
    "601318.SH": {  # 中国平安
        # API实测(2026-06-22): close=51.98, pe=7.09, pb=0.92, dv_ttm=4.94%, mv=9412亿
        # 分红: 2025年报1.75(ex:20260610) + 2025中期0.95(ex:20251024)
        # TTM = 1.75+0.95 = 2.70元，2.70/51.98=5.19%；dv_ttm=4.94%略低（可能TTM窗口差异）
        # 以自算5.19%为准，2024年报1.62(ex:20250630)已滚出TTM
        "close": 51.98, "pe_ttm": 7.09, "pb": 0.92,
        "div_yield": 5.19, "roe": 13.85, "dps_latest": 2.70,
        "buyback_yield": 0.5, "revenue_growth": 12.6, "net_profit_growth": 47.8,
        "payout_ratio": 42.0, "total_mv": 9412.0,
        "note": "API实测(2026-06-22)：close=51.98，dv_ttm=4.94%，TTM自算(2025年报1.75+中期0.95)=5.19%；ROE 13.85%，净利+47.8%；连续十多年分红稳增"
    },
    "601088.SH": {  # 中国神华
        # API实测(2026-06-22): close=41.51, pe=17.46, pb=1.87, dv_ttm=7.03%, mv=9003亿
        # 分红: 2025中期0.98(ex:20251110) + 2024年报2.26(ex:20250707)
        # TTM = 0.98+2.26 = 3.24元，3.24/41.51=7.8%；dv_ttm=7.03%含跨年数据
        # 2025年报分红预案待公告，参考历史惯例约1.0-1.1元；全年2025预期=0.98+1.05=2.03
        # 自算2025全年股息率 = 2.03/41.51 = 4.89%（更能代表真实年度回报）
        "close": 41.51, "pe_ttm": 17.46, "pb": 1.87,
        "div_yield": 4.89, "roe": 14.04, "dps_latest": 2.03,
        "buyback_yield": 0.0, "revenue_growth": -1.4, "net_profit_growth": -1.7,
        "payout_ratio": 72.0, "total_mv": 9003.0,
        "note": "API实测(2026-06-22)：close=41.51，dv_ttm=7.03%(TTM跨年含24年报2.26+25中期0.98)；自算2025全年(中0.98+年报预案约1.05)=2.03元，股息率4.89%；ROE 14.04%"
    },
    ...
    "159399.SZ": {  # 国泰现金流ETF
        "close": 0.972, "pe_ttm": 10.5, "pb": 0.0,
        "div_yield": 2.80,
        "roe": 12.0, "dps_latest": 0.0,
        "buyback_yield": 0.0, "revenue_growth": 0.0, "net_profit_growth": 0.0,
        "payout_ratio": 0.0, "total_mv": 53.6,
        "note": "国泰现金流ETF(159399)，跟踪富时中国A股自由现金流聚焦指数，2025-02-19成立，规模53.6亿，侧重FCF质量因子"
    },
    "159201.SZ": {  # 华夏自由现金流ETF
        "close": 1.128, "pe_ttm": 10.0, "pb": 0.0,
        "div_yield": 2.50,
        "roe": 12.5, "dps_latest": 0.0,
        "buyback_yield": 0.0, "revenue_growth": 0.0, "net_profit_growth": 0.0,
        "payout_ratio": 0.0, "total_mv": 184.5,
        "note": "华夏自由现金流ETF(159201)，跟踪国证自由现金流指数，2025-02-19成立，规模184.5亿，现金流ETF中流动性最佳"
    },
    "159229.SZ": {  # 广发中证800现金流ETF
        "close": 1.162, "pe_ttm": 10.8, "pb": 0.0,
        "div_yield": 2.60,
        "roe": 11.5, "dps_latest": 0.0,
        "buyback_yield": 0.0, "revenue_growth": 0.0, "net_profit_growth": 0.0,
        "payout_ratio": 0.0, "total_mv": 1.6,
        "note": "广发中证800现金流ETF(159229)，跟踪中证800自由现金流指数，2025-05-06成立，规模偏小但成分池与自建E版重合度高"
    },
    "601225.SH": {  # 陕西煤业
        # API实测(2026-06-22): close=23.30, pe=13.97, pb=2.21, dv_ttm=5.49%, mv=2259亿
        # 分红: 2025年报0.909(ex:20260626,本周即将除权!) + 2025中期0.039(ex:20250926)
        # TTM = 0.909+0.039 = 0.948元（其中年报0.909本周末除权，价格会调整）
        # 除权后参考价 ≈ 23.30 - 0.909 = 22.39元；除权后股息率约4.24%
        # dv_ttm=5.49%基于当前含权价格，除权后真实收益率以年度DPS/当时价格为准
        "close": 23.30, "pe_ttm": 13.97, "pb": 2.21,
        "div_yield": 5.49, "roe": 24.86, "dps_latest": 0.948,
        "buyback_yield": 0.0, "revenue_growth": 1.5, "net_profit_growth": -3.2,
        "payout_ratio": 58.0, "total_mv": 2259.0,
        "note": "API实测(2026-06-22)：close=23.30，dv_ttm=5.49%(年报0.909将于20260626除权!)，ROE 24.86%；除权后参考价≈22.39；850煤价下2026年业绩预期改善"
    },
    "000408.SZ": {  # 藏格矿业
        # 2025年报：营收24.01亿+3.3%，归母净利润27.43亿+47.4%，ROE 25.59%
        # 全年DPS=2.5元/股（tushare dividend），分红率61.1%
        # 股价70.10元(2026-06-26)，PE=23.51x，PB=6.23x，市值~1100亿
        # 72%利润来自巨龙铜矿30.78%权益（投资收益），主业为钾肥+碳酸锂
        "close": 70.10, "pe_ttm": 23.51, "pb": 6.23,
        "div_yield": 3.57, "roe": 25.59, "dps_latest": 2.50,
        "buyback_yield": 0.0, "revenue_growth": 3.3, "net_profit_growth": 47.4,
        "payout_ratio": 61.0, "total_mv": 1100.0,
        "note": "2026-06-26更新：股价70.10元，DPS 2.5元/股，股息率3.57%；钾锂铜三轮驱动，巨龙铜矿贡献72%利润，回调后股息率明显提升"
    },
    "000807.SZ": {  # 云铝股份
        # 2025年报：营收440.72亿+12.5%，归母净利润60.55亿+37.2%，ROE 20.06%
        # 全年累计分红24.24亿(含中期)，每股约0.70元(中期0.32+年报0.379)，分红率约40%
        # 股价24.17元(2026-06-21)，PE≈9.66x，PB≈2.35x，市值~838亿
        "close": 24.17, "pe_ttm": 9.66, "pb": 2.35,
        "div_yield": 2.89, "roe": 20.06, "dps_latest": 0.70,
        "buyback_yield": 0.0, "revenue_growth": 12.5, "net_profit_growth": 37.2,
        "payout_ratio": 40.0, "total_mv": 838.2,
        "note": "2025年报：水电铝龙头，净利60.55亿+37.2%，全年分红0.70元/股，股息率2.89%；绿电溢价+碳关税受益，股价回调后吸引力上升"
    },
    "600988.SH": {  # 赤峰黄金
        # 2025年报：营收86.44亿+38.9%，归母净利润23.11亿+84.3%，ROE 28.9%
        # 全年分红0.32元/股，分红率仅19.7%
        # 股价26.62元(2026-06-26)，PE=14.10x，PB=3.54x，市值~506亿
        "close": 26.62, "pe_ttm": 14.10, "pb": 3.54,
        "div_yield": 1.20, "roe": 28.9, "dps_latest": 0.32,
        "buyback_yield": 0.0, "revenue_growth": 38.9, "net_profit_growth": 84.3,
        "payout_ratio": 19.7, "total_mv": 505.9,
        "note": "2026-06-26更新：股价26.62元，PE=14.10x，DPS 0.32元/股，股息率1.20%；高成长金矿但分红率低(19.7%)，强周期高波动"
    },
    "600519.SH": {  # 贵州茅台
    ...
    "600329.SH": {  # 达仁堂
        "close": 37.84, "pe_ttm": 13.36, "pb": 3.87,
        "div_yield": 12.66, "roe": 28.52, "dps_latest": 4.79,
        "buyback_yield": 0.0, "revenue_growth": -32.7, "net_profit_growth": -4.4,
        "payout_ratio": 84.5, "total_mv": 291.4,
        "note": "2026-06-21更新：股价37.84元，2025年总分红4.79元（中期2.45元已实施+年报预案2.34元待实施），自算股息率12.66%(=4.79/37.84)；ROE 28.52%，分红21年；中期高额分红来自利润分配调整"
    },
    "000423.SZ": {  # 东阿阿胶
    ...
    "000568.SZ": {  # 泸州老窖
        # tushare实测(2026-06-27)：股价75.20元，PE=11.13x，PB=2.15，自算股息率=7.68%
        # 2025年全年分红=中期1.358(已实施)+年报预案4.417=5.775元/股，股息率=5.775/75.20=7.68%
        # 2025年报：营收231.27亿-4.8%，净利润107.95亿-7.0%，ROE=22.29%
        "close": 75.20, "pe_ttm": 11.13, "pb": 2.15,
        "div_yield": 7.68, "roe": 22.29, "dps_latest": 5.78,
        "buyback_yield": 0.0, "revenue_growth": -4.8, "net_profit_growth": -7.0,
        "payout_ratio": 65.0, "total_mv": 1106.9,
        "note": "2026-06-27更新：股价75.20元，全年分红5.775元/股，股息率7.68%；国窖1573高端化趋势明确，回调后股息率极具吸引力"
    },
    "601919.SH": {  # 中远海控
    ...
    "600011.SH": {  # 华能国际
        # 2025年报：净利润194.36亿+45.5%，营收1729.75亿，ROE=10.30%
        # 2025年分红：仅年报预案0.4元/股（无中期），总股本≈157亿股，分红率≈44%
        # 股价7.64元(2026-06-21)，PE=8.62x，PB=1.71，市值1199亿
        # 股息率 = 0.4 / 7.64 = 5.24%（自算准确）
        # tushare dv_ttm=3.53%含2024年报0.27元已除权(2025-07-10)，未含2025年报预案 → 偏低
        "close": 7.64, "pe_ttm": 8.62, "pb": 1.71,
        "div_yield": 5.24, "roe": 10.3, "dps_latest": 0.40,
        "buyback_yield": 0.0, "revenue_growth": -6.2, "net_profit_growth": 42.2,
        "payout_ratio": 44.0, "total_mv": 1199.3,
        "note": "2025年报：净利194.36亿+42.2%，营收-6.2%因电价下滑，年报分红0.4元/股(无中期)，股息率5.24%；火电龙头煤价下行利好利润弹性；自算股息率准确，三源偏差来自dv_ttm TTM滚动效应"
    },
    "600350.SH": {  # 山东高速
    ...
    "600066.SH": {  # 宇通客车
        # API实测(2026-06-22): close=27.42, pe=11.12, pb=3.74, dv_ttm=5.47%, mv=607亿
        # 分红: 2025年报2.0(ex:20260515) + 2025中期0.5(ex:20250911)
        # TTM = 2.0+0.5 = 2.50元，2.50/27.42=9.12%；但dv_ttm=5.47%严重偏低
        # 原因：中期0.5(20250911)在TTM内，但年报2.0(20260515)除权不足1年，
        # 可能tushare dv_ttm仅含部分窗口数据；以自算9.12%为准
        "close": 27.42, "pe_ttm": 11.12, "pb": 3.74,
        "div_yield": 9.12, "roe": 30.11, "dps_latest": 2.50,
        "buyback_yield": 0.0, "revenue_growth": 37.6, "net_profit_growth": 126.5,
        "payout_ratio": 60.0, "total_mv": 607.0,
        "note": "API实测(2026-06-22)：close=27.42，dv_ttm=5.47%(tushare TTM窗口问题，年报2.0未完整计入)；自算(2.50/27.42)=9.12%；ROE 30.11%，净利+126.5%；客车行业龙头"
    },
    "600377.SH": {  # 宁沪高速
    ...
    "600887.SH": {  # 伊利股份
        # 2025年报：净利润115.6亿，ROE=21.4%，连续20+年分红
        # 2024年DPS=1.22元/股（含特别分红0.15），股价24.67元，自算4.95%
        # 乳业双寡头，渠道+品牌壁垒极深，分红率55%+
        "close": 24.67, "pe_ttm": 12.9, "pb": 2.62,
        "div_yield": 4.95, "roe": 21.4, "dps_latest": 1.22,
        "buyback_yield": 0.5, "revenue_growth": -3.0, "net_profit_growth": 5.0,
        "payout_ratio": 55.0, "total_mv": 1580.0,
        "note": "2024年DPS=1.22元/股，股价24.67元，股息率4.95%；乳业龙头，ROE 21%+，连续20+年分红"
    },
    "600598.SH": {  # 北大荒
        # 2025年报：净利润13.51亿+0.7%，ROE=14.76%，国家粮仓战略资产
        # 2025年DPS=0.55元/股，股价10.69元，自算股息率5.15%
        # 黑龙江农垦央企，黑土地资源垄断，粮食安全战略标的
        "close": 10.69, "pe_ttm": 15.73, "pb": 2.21,
        "div_yield": 5.15, "roe": 14.76, "dps_latest": 0.55,
        "buyback_yield": 0.0, "revenue_growth": -5.7, "net_profit_growth": 0.7,
        "payout_ratio": 50.0, "total_mv": 190.0,
        "note": "2026-06-26更新：股价10.69元，DPS 0.55元/股，股息率5.15%；ROE 14.76%，黑土地资源垄断，回调后股息率突破5%"
    },
