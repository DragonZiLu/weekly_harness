...
FALLBACK_DATA = {
    ...
    "600066.SH": {  # 宇通客车
        # tushare实测(2026-06-21)：股价26.04元，PE=10.56x，PB=3.55，自算股息率=9.60%
        # 2025年报：ROE=38.27%，净利润增速+34.9%，全年DPS=2.50(中期0.5+年报2.0)
        # 中国客车行业绝对龙头，全球市占率超15%，新能源客车领先
        "close": 26.04, "pe_ttm": 10.56, "pb": 3.55,
        "div_yield": 9.60, "roe": 38.27, "dps_latest": 2.50,
        "buyback_yield": 0.0, "revenue_growth": 9.5, "net_profit_growth": 34.9,
        "payout_ratio": 60.0, "total_mv": 576.5,
        "note": "2026-06-21更新: 股价26.04元，PE=10.56x，自算股息率9.60%(DPS 2.50)；ROE 38.27%极优质，回调后股息率大幅提升"
    },
    "600377.SH": {  # 宁沪高速
