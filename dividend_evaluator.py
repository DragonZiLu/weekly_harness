...
FALLBACK_DATA = {
    ...
    "600329.SH": {  # 达仁堂
        "close": 39.39, "pe_ttm": 13.91, "pb": 4.03,
        "div_yield": 9.47, "roe": 28.5, "dps_latest": 2.34,
        "buyback_yield": 0.0, "revenue_growth": -32.7, "net_profit_growth": -4.4,
        "payout_ratio": 84.5, "total_mv": 303.3,
        "note": "2026-06-02更新：2025年分红4.79元（中期2.45元已实施+年报预案2.34元待实施），TTM股息率9.47%，ROE 28.5%，分红21年；中期高额分红来自利润分配调整"
    },
    "000423.SZ": {  # 东阿阿胶
